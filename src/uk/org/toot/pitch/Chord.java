...
public class Chord
{
    ...
    Chord(String aSymbol, String aSpelling, String aName) {
        symbol = aSymbol;
        spelling = aSpelling;
        name = aName;
    ...
    void decodeIntervals(String aSpelling) {
        ...
        intervals = new int[degrees.length-1];
	    for (int i = 0; i < intervals.length; i++) {
        	intervals[i] = Interval.spelt(degrees[i+1]);
        }
    }
    ...
    public int getPoly() { return 1+intervals.length; }
	...
	// ---- all the static class stuff is below ----------------------------
...
/*        System.out.print("Chord: no match for ");
        for ( int i = 0; i < someIntervals.length; i++ ) {
            System.out.print(someIntervals[i]+", ");
        }
        System.out.print("\t1, ");
        for ( int i = 0; i < someIntervals.length; i++ ) {
            System.out.print(Interval.spell(someIntervals[i])+", ");
        }
        System.out.println(""); */
        return null;
    }
    ...
    private static void addChords() {
		...
		addChord("6/7sus",		"1 4 5 6 7",		"six seven suspended");
        // six note
...
//		addChord("m11-13-9-5?", 	"1 b3 b5 b7 b9 11 b13",	"minor eleventh flat 13 flat 9 diminished fifth?");
		...
		addChord("13sus",		"1 4 5 b7 9 13",	"thirteenth suspended");
	}
}
