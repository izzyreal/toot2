...
public class PlateControls extends AudioControls implements PlateVariables
{
	...
	protected FloatControl createInputDiffusion1Control() {
		FloatControl control = new FloatControl(INPUT_DIFFUSION_1, "Diff1", LinearLaw.UNITY, 0.01f, 0.75f);
		control.setInsertColor(Color.DARK_GRAY);
		return control;
	}
	
	protected FloatControl createInputDiffusion2Control() {
		FloatControl control = new FloatControl(INPUT_DIFFUSION_2, "Diff2", LinearLaw.UNITY, 0.01f, 0.625f);
		control.setInsertColor(Color.DARK_GRAY);
		return control;
	}
	...
	protected FloatControl createDecayDiffusion1Control() {
		FloatControl control = new FloatControl(DECAY_DIFFUSION_1, "Diff1", LinearLaw.UNITY, 0.01f, 0.7f);
		control.setInsertColor(Color.DARK_GRAY);
		return control;
	}
	
	protected FloatControl createDecayDiffusion2Control() {
		FloatControl control = new FloatControl(DECAY_DIFFUSION_2, "Diff2", LinearLaw.UNITY, 0.01f, 0.5f);
		control.setInsertColor(Color.DARK_GRAY);
		return control;
	}
