...
public class FIRDesignerPM
{
    ...
    public static int estimatedOrder(float trband, float atten, float ripple) {
        ...
        return Math.round((-10.0f*(float)Math.log10(deltaP*deltaS) - 13)/(14.6f*trband));        
    }
    ...
    public static float[] design(FilterShape shape, float f1, float f2, float trband, float atten, float ripple, int order) {
        ...
        if (shape == FilterShape.BPF || shape == FilterShape.NOTCH) numBands = 3;
