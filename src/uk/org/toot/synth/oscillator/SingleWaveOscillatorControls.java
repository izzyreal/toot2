...
public class SingleWaveOscillatorControls extends CompoundControl implements SingleWaveOscillatorVariables 
{
	...
	public SingleWaveOscillatorControls(int instanceIndex, String name, int idOffset, boolean master) {
		this(OscillatorIds.WAVE_OSCILLATOR_ID, instanceIndex, name, idOffset, master);
	}

	public SingleWaveOscillatorControls(int id, int instanceIndex, String name, final int idOffset, boolean master) {
		super(id, name);
...
//		    public boolean isWidthLimited() { return false; }
	...
	protected Wave deriveWave() {
		...
		return SingleWaves.create(name);
	}
