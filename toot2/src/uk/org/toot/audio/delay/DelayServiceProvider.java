...
public class DelayServiceProvider extends TootAudioServiceProvider
{
    public DelayServiceProvider() {
        ...
        addControls(ModulatedDelayControls.class, DelayIds.MODULATED_DELAY_ID, getString("Modulated Delay"), family, "0.1");
        addControls(MultiTapDelayStereoControls.class, DelayIds.MULTI_TAP_DELAY_ID, getString("Stereo.Multi.Tap.Delay"), family, "0.1");
